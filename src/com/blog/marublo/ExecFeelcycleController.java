		...
		if(GYM.equals("2")){
			...
			while(true){
				...
				*/
				...
				Long bmonLessonDayCount = (Long) js.executeScript("var box=document.getElementById('scroll-box'); return  box.getElementsByClassName('grid').getElementsByTagName('div').length;");
